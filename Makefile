...
ifeq ($(OS),Windows_NT)
	...
	LDFLAGS=-lSDL2 -lSDL2_image -lSDL2_mixer -ljsoncpp -llua5.2
endif
...
suidao:        src/content.o src/game.o src/game_loop.o src/main.o src/map.o src/game_state.o src/animation.o src/unit.o src/lua_api.o
